...
export class WhatsappService {
  ...
  async getStatus(sessionId: string) {
    ...
    // 🎯 O PULO DO GATO: Se a sessão está desconectada (novo usuário ou derrubada), dá o start sob demanda
  ...
  async listGroups(sessionId: string) {
    ...
    // 🎯 CORREÇÃO: Passando o sessionId adiante para o arquivo de serviço interno do Baileys
