...
import mainRoutes from "../../dashboard/src/routes/main.routes";
...
app.use((req, res, next) => {
  res.setHeader(
    ...
    "default-src 'self'; " +
      "connect-src 'self' http://localhost:3333 https://api.qrserver.com; " +
...
app.use(
  express.static(
    path.resolve(process.cwd(), "apps", "dashboard", "src", "public"),
  ),
);
